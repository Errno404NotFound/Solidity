...
contract PIXLS is ERC721, Ownable {
    ...
    // max supply
    uint256 constant public maxPIXLS = 100;
    // team reserve
    ...
    // whitelist amount
    uint256 public _PIXLSToBeReserved = 15;
    // total supply so far
    ...
    // Addresses to withdraw to
    // CHANGE THESE
    // address w1 = 0x0000000000000000000000000000000000000000;
    // address w2 = 0x0000000000000000000000000000000000000000;
    // address w3 = 0x0000000000000000000000000000000000000000;
    ...
    function reserve(uint256 amount) public payable {
        ...
        require(amount <= maxPerTx, "Cannot reserve more than 1 token");
